  	...
  	<div id="loginbox">
		<form id="loginform" action="" method="post">
			...
			<div class="control-group">
				<div class="controls">
					<div class="main_input_box">
						<span class="add-on bg_lg"><i class="fa fa-user"></i></span><input type="text" id="account" " autofocus="autofocus" maxlength="60" placeholder="请输入账号...">
					</div>
				</div>
			</div>
			<div class="control-group">
			...
			<div class="form-actions">
				<span><a  href="javascript:void(0);" onclick="login(this)" class="btn btn-success">登陆</a></span>
			</div>
		</form>
	</div>
